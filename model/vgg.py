...
class VGG:
    def __init__(self, input_, vgg_model_path='VGG_Model/imagenet-vgg-verydeep-19.mat', name='VGG', reuse=False):
        with tf.variable_scope(name, reuse=reuse):
            net = {}
            vgg_rawnet = scipy.io.loadmat(vgg_model_path)
            vgg_layers = vgg_rawnet['layers'][0]
            net['input'] = input_ - np.array([123.6800, 116.7790, 103.9390]).reshape((1, 1, 1, 3))
